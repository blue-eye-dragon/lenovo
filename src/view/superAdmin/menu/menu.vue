  ...
  <div>
    <div class="button-box clearflex">
      <el-button size="mini"
                 type="primary"
                 icon="el-icon-plus"
                 @click="addMenu('0')">新增根菜单</el-button>
    </div>
      ...
      <el-table-column fixed="right"
        ...
        <template slot-scope="scope">
          <el-button size="mini"
                     type="primary"
                     icon="el-icon-edit"
                     @click="addMenu(scope.row.ID)">添加子菜单</el-button>
          <el-button size="mini"
                     type="primary"
                     icon="el-icon-edit"
    ...
    <el-dialog :before-close="handleClose"
      ...
      <el-form ref="menuForm"
        ...
        <el-form-item prop="path"
          ...
          <div slot="label"
            ...
            路由path
            <el-checkbox v-model="checkFlag"
                         style="float:right;margin-left:20px;">添加参数</el-checkbox>
          </div>
        ...
        <el-form-item label="文件路径"
          ...
          <el-button size="mini"
                     @click="form.component = 'view/routerHolder.vue'">点我设置</el-button>
        </el-form-item>
        ...
        <el-form-item label="closeTab"
                      prop="meta.closeTab"
                      style="width:30%">
          <el-select v-model="form.meta.closeTab"
      ...
      <div>
        <el-button size="small"
                   type="primary"
                   icon="el-icon-edit"
                   @click="addParameter(form)">新增菜单参数</el-button>
