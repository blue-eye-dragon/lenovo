  ...
  <div>
    <div class="search-term">
      <el-form :inline="true"
        ...
        <el-form-item label="展示值">
          <el-input v-model="searchInfo.label"
                    placeholder="搜索条件" />
        </el-form-item>
        <el-form-item label="字典值">
          <el-input v-model="searchInfo.value"
                    placeholder="搜索条件" />
        </el-form-item>
        ...
        <el-form-item>
          <el-button size="mini"
                     type="primary"
                     icon="el-icon-plus"
                     @click="openDialog">新增字典项</el-button>
        </el-form-item>
      </el-form>
    </div>
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button size="small"
                     type="primary"
                     @click="updateSysDictionaryDetail(scope.row)">变更</el-button>
          <el-popover v-model="scope.row.visible"
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button type="primary"
                         size="mini"
                         @click="deleteSysDictionaryDetail(scope.row)">确定</el-button>
            </div>
    ...
    <el-dialog :before-close="closeDialog"
      ...
      <el-form ref="elForm"
        ...
        <el-form-item label="字典值"
                      prop="value">
          <el-input-number v-model.number="formData.value"
                           step-strictly
                           :step="1"
                           placeholder="请输入字典值"
                           clearable
        ...
        <el-form-item label="排序标记"
                      prop="sort">
          <el-input-number v-model.number="formData.sort"
                           placeholder="排序标记" />
        </el-form-item>
      </el-form>
      <div slot="footer"
