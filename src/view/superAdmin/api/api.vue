  ...
  <div>
    <div class="search-term">
      <el-form :inline="true"
        ...
        <el-form-item label="api组">
          <el-input v-model="searchInfo.apiGroup"
                    placeholder="api组" />
        </el-form-item>
        <el-form-item label="请求">
          <el-select v-model="searchInfo.method"
                     clearable
                     placeholder="请选择">
        ...
        <el-form-item>
          ...
          <el-button size="mini"
                     type="primary"
                     icon="el-icon-plus"
                     @click="openDialog('addApi')">新增</el-button>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column label="api路径"
                       ...
                       prop="path"
                       sortable="custom" />
      <el-table-column label="api分组"
                       min-width="150"
                       prop="apiGroup"
                       sortable="custom" />
      <el-table-column label="api简介"
                       min-width="150"
                       prop="description"
                       sortable="custom" />
      <el-table-column label="请求"
        ...
        <template slot-scope="scope">
          <div>
            {{ scope.row.method }}
            <el-tag :key="scope.row.methodFiletr"
    ...
    <el-dialog :before-close="closeDialog"
      ...
      <el-form ref="apiForm"
        ...
        <el-form-item label="api分组"
                      prop="apiGroup">
          <el-input v-model="form.apiGroup"
                    autocomplete="off" />
        </el-form-item>
